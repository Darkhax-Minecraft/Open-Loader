...
dependencies {
    // NeoForge
    implementation group: 'net.darkhax.openloader', name: 'openloader-neoforge-1.21.1', version: '21.1.0'

    // Forge
    implementation group: 'net.darkhax.openloader', name: 'openloader-forge-1.21.1', version: '21.1.0'

    // Fabric & Quilt
    modImplementation group: 'net.darkhax.openloader', name: 'openloader-fabric-1.21.1', version: '21.1.0'

    // Common / MultiLoader / Vanilla
    compileOnly group: 'net.darkhax.openloader', name: 'openloader-common-1.21.1', version: '21.1.0'
}
```
<!-- maven-end -->
